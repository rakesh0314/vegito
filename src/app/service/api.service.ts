...
export class ApiService {
  ...
  cartdata(res):Observable<any>
  {
    ...
    const header = {'Auth_key': 'InfinityTest','Service':'Vegito','ID':res.user_id,'Api_key':res.API_key};
  ...
  makeOrder(res,method,product,address):Observable<any>
  {
    ...
    const header = {'Auth_key': 'InfinityTest','Service':'Vegito','ID':res.user_id,'Api_key':res.API_key};
    return this.httpClient.post(url,{'products':product,'address':address},{headers:header});
  }
